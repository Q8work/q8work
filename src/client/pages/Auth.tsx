    ...
    <AuthShell title="تسجيل الدخول">
      <form onSubmit={submit} className="space-y-4">
        ...
        <p className="text-center text-sm text-brand-dark">
          ليس لديك حساب؟{" "}
          <Link to={`/register${redirect !== "/" ? `?redirect=${encodeURIComponent(redirect)}` : ""}`} className="font-bold text-brand-dark underline">
            أنشئ حساباً
          </Link>
        </p>
      </form>
  ...
  return (
    <AuthShell title="إنشاء حساب جديد">
      <form onSubmit={submit} className="space-y-4">
        ...
        <p className="text-center text-sm text-brand-dark">
          لديك حساب؟{" "}
          <Link to={`/login${redirect !== "/" ? `?redirect=${encodeURIComponent(redirect)}` : ""}`} className="font-bold text-brand-dark underline">
            تسجيل الدخول
          </Link>
        </p>
      </form>
